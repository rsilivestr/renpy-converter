import { convertToRenpyScript } from '../src/';

describe('plaint text dialog, single line', () => {

  const plainTextDialogSingleLine = {
  ...
  test('adds 1 + 2 to equal 3', () => {
    convertToRenpyScript(plainTextDialogSingleLine)
